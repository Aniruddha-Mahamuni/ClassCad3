package com.example.classcad.activity;
...
import com.example.classcad.context.ApplicationContext;
import com.example.classcad.db.DBAdapter;
...
public class AddAttandanceSessionActivity<AddAttandanceActivity> extends Activity {
    ...
    private String[] subjectFYString = new String[] {"ENG","BSC"};
    private String[] subjectSYString = new String[] {"DTE","JPR"};
    private String[] subjectTYString = new String[] {"DWM","MAD"};

    private String[] subjectFinal = new String[] {"ENG","BSC","DTE","JPR","DCC","DWM","MAD"};
