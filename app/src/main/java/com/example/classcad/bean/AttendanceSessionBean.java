...
public class AttendanceSessionBean {
    ...
    public int attendance_session_faculty_id;
    public String attendance_session_department;
    public String attendance_session_class;
    public String attendance_session_date;
    public String attendance_session_subject;
